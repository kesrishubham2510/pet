package com.myreflectionthoughts.apigateway.core.constant;

public class ServiceConstant {

    public static final String masterServiceQualifier = "masterService";
    public static final String petServiceQualifier = "petService";
