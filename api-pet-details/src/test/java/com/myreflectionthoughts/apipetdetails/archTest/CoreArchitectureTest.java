package com.myreflectionthoughts.apipetdetails.archTest;
...
public class CoreArchitectureTest {
    ...
    public CoreArchitectureTest(){
        packagePath = "com.myreflectionthoughts.apipetdetails";
        importer = new ClassFileImporter();
    }

    @Test
    void enums_must_not_reside_outside_core(){
        ArchRule rule = classes()
                .that()
                .areEnums()
                .should()
                .resideInAPackage(packagePath+".core.enums")
                .because("Enums are the core around which the entity takes shape");
    ...
    @Test
    void entity_should_reside_in_entity_under_core(){

        ArchRule rule = classes()
                .that()
                .areAnnotatedWith(Document.class)
                .should()
                .resideInAPackage(packagePath+".core.entity..")
                .because("Entities belong to the application core");
    ...
    @Test
    void useCases_can_be_accessible_only_through_inside_core_or_handlers(){
